...
-- Lock both tables down for the anon and authenticated roles; the app only
-- reaches them through the server-side client. consolidated_setup.sql does
-- the same on a fresh database, so this only matters where the tables were
