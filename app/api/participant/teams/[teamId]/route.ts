...
import { eq, and } from 'drizzle-orm'; // count removed - used only in commented DELETE endpoint
...
// DELETE endpoint removed - Leave team automatically handles deletion when last member
