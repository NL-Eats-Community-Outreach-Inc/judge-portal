  ...
  try {
    ...
    for (const user of testUsers) {
      ...
      if (error) {
        ...
        if (user.role === 'admin') {
          await supabase.from('users').update({ role: 'admin' }).eq('id', authUser.user.id);
        }
    ...
    const eventTeamsData: TeamSeed[][] = [
      ...
      [
        {
          name: 'FarmBot Collective',
          description: 'Autonomous robotics for precision planting and harvesting',
          awardType: 'technical',
          presentationOrder: 1,
        },
        {
          name: 'CropSense AI',
          description: 'AI-powered crop health monitoring using drone imagery',
          awardType: 'both',
          presentationOrder: 2,
        },
        {
          name: 'AgriChain',
          description: 'Blockchain-based supply chain traceability for fresh produce',
          awardType: 'business',
          presentationOrder: 3,
        },
        {
          name: 'HarvestPlus',
          description: 'Yield optimization platform using soil and weather data',
          awardType: 'both',
          presentationOrder: 4,
        },
        {
          name: 'SoilTech Labs',
          description: 'Real-time soil health diagnostics with IoT sensors',
          awardType: 'technical',
          presentationOrder: 5,
        },
        {
          name: 'FieldOps Pro',
          description: 'Farm operations management and workforce coordination app',
          awardType: 'business',
          presentationOrder: 6,
        },
      ],
      ...
      [
        {
          name: 'Urban Harvest',
          description: 'Vertical farming systems for high-density city food production',
          awardType: 'both',
          presentationOrder: 1,
        },
        {
          name: 'FoodLoop',
          description: 'Circular food economy platform reducing post-harvest waste',
          awardType: 'business',
          presentationOrder: 2,
        },
        {
          name: 'NutriGrid',
          description: 'Equitable nutrition distribution network for underserved communities',
          awardType: 'business',
          presentationOrder: 3,
        },
        {
          name: 'PolyFarm Co',
          description: 'Polyculture design tools for resilient mixed cropping systems',
          awardType: 'technical',
          presentationOrder: 4,
        },
        {
          name: 'WasteNot Foods',
          description: 'AI-driven food surplus redistribution and shelf-life extension',
          awardType: 'both',
          presentationOrder: 5,
        },
        {
          name: 'OpenFarm Alliance',
          description: 'Open-source cooperative farming data platform',
          awardType: 'technical',
          presentationOrder: 6,
        },
      ],
      ...
      [
        {
          name: 'CropMind AI',
          description: 'Deep learning models for multi-crop disease and pest identification',
          awardType: 'technical',
          presentationOrder: 1,
        },
        {
          name: 'PestVision',
          description: 'Computer vision pest detection using affordable edge cameras',
          awardType: 'both',
          presentationOrder: 2,
        },
        {
          name: 'YieldPredict',
          description: 'ML-based seasonal yield forecasting for smallholder farmers',
          awardType: 'both',
          presentationOrder: 3,
        },
        {
          name: 'ClimateAgri',
          description: 'Climate-adaptive planting schedules powered by predictive AI',
          awardType: 'business',
          presentationOrder: 4,
        },
        {
          name: 'RootDeep ML',
          description: 'Underground root health analysis using ML-processed sensor data',
          awardType: 'technical',
          presentationOrder: 5,
        },
        {
          name: 'AgriLens',
          description: 'Satellite imagery analysis platform for regional crop monitoring',
          awardType: 'both',
          presentationOrder: 6,
        },
      ],
      ...
      [
        {
          name: 'NourishNet',
          description:
            'Last-mile food delivery network connecting surplus to food-insecure regions',
          awardType: 'business',
          presentationOrder: 1,
        },
        {
          name: 'GrainPath',
          description:
            'Transparent grain storage and logistics platform for smallholder cooperatives',
          awardType: 'both',
          presentationOrder: 2,
        },
        {
          name: 'HungerBridge',
          description: 'Real-time hunger mapping and emergency food response coordination tool',
          awardType: 'business',
          presentationOrder: 3,
        },
        {
          name: 'FoodReach',
          description: 'Mobile-first market access platform for rural smallholder farmers',
          awardType: 'both',
          presentationOrder: 4,
        },
        {
          name: 'SeedBank Pro',
          description: 'Community-owned digital seed exchange and crop diversity registry',
          awardType: 'technical',
          presentationOrder: 5,
        },
        {
          name: 'FarmAid Tech',
          description: 'Subsidized input financing and micro-credit platform for smallholders',
          awardType: 'business',
          presentationOrder: 6,
        },
      ],
      ...
      [
        {
          name: 'AquaFarm',
          description: 'Automated drip irrigation scheduling based on real-time soil moisture data',
          awardType: 'technical',
          presentationOrder: 1,
        },
        {
          name: 'Dripsense',
          description: 'Low-cost wireless irrigation sensor network for smallholder plots',
          awardType: 'both',
          presentationOrder: 2,
        },
        {
          name: 'RainLogic',
          description: 'Rainfall prediction and rainwater harvesting optimization platform',
          awardType: 'both',
          presentationOrder: 3,
        },
        {
          name: 'HydroField',
          description: 'Hydroponic water recycling systems for water-scarce environments',
          awardType: 'technical',
          presentationOrder: 4,
        },
        {
          name: 'WaterWise AG',
          description: 'Farm-level water accounting and efficiency benchmarking tool',
          awardType: 'business',
          presentationOrder: 5,
        },
        {
          name: 'IrriTech',
          description: 'Solar-powered smart pump and irrigation management system',
          awardType: 'both',
          presentationOrder: 6,
        },
      ],
      ...
      [
        {
          name: 'DataHarvest',
          description: 'Unified farm data ingestion pipeline for multi-source sensor integration',
          awardType: 'technical',
          presentationOrder: 1,
        },
        {
          name: 'FieldMetrics',
          description: 'Interactive agronomic dashboard with KPI tracking for farm managers',
          awardType: 'business',
          presentationOrder: 2,
        },
        {
          name: 'CropAnalytica',
          description: 'Statistical crop performance analysis and benchmarking suite',
          awardType: 'both',
          presentationOrder: 3,
        },
        {
          name: 'SatFarm AI',
          description: 'Satellite-derived vegetation index analysis for regional yield estimation',
          awardType: 'technical',
          presentationOrder: 4,
        },
        {
          name: 'AgriInsights',
          description:
            'Natural language reporting tool that turns farm data into actionable insights',
          awardType: 'both',
          presentationOrder: 5,
        },
        {
          name: 'TerraScan',
          description: 'Ground-truth validation platform for remote sensing accuracy improvement',
          awardType: 'technical',
          presentationOrder: 6,
        },
      ],
    ...
    const criteriaData = [
      ...
      },
      {
        ...
        description: 'Uniqueness and creative approach to problem solving',
        weight: 30,
        category: 'technical' as const,
        displayOrder: 2,
      },
      ...
      {
        name: 'Business Value',
        description: 'Market potential and business viability',
        weight: 40,
      ...
      },
      {
        ...
        description: 'Potential for scaling and future growth',
        weight: 30,
        category: 'business' as const,
        displayOrder: 6,
      },
    ...
    for (let i = 0; i < createdEvents.length; i++) {
      ...
      const criteria = await db
        ...
        .values(criteriaData.map((c) => ({ ...c, eventId: event.id, minScore: 1, maxScore: 10 })))
        .returning();
      ...
      if (judgeUsers.length > 0) {
        await db
          ...
          .values(judgeUsers.map((judge) => ({ eventId: event.id, judgeId: judge.id })))
          .onConflictDoNothing();
      }
    ...
    console.log('  4. Global Food Security Hackathon 2025 (open)');
    console.log('  5. Smart Irrigation & Water Management Summit 2025 (active)');
    console.log('  6. AgriData Analytics Bootcamp 2024 (completed)');
    console.log('\n📝 Notes:');
